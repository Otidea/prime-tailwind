...
card1.addEventListener('mouseenter', function() {
    ...
    img.src = './src/img/papierBlanc.svg';
});

card1.addEventListener('mouseleave', function() {
    const img = card1.querySelector('img');
    img.src = './src/img/papierColor.svg';
});

card2.addEventListener('mouseenter', function() {
    const img = card2.querySelector('img');
    img.src = './src/img/pouceBlanc.svg';
});

card2.addEventListener('mouseleave', function() {
    const img = card2.querySelector('img');
    img.src = './src/img/pouceMultiColor.svg';
});

card3.addEventListener('mouseenter', function() {
    const img = card3.querySelector('img');
    img.src = './src/img/calculaBlanc.svg';
});

card3.addEventListener('mouseleave', function() {
    const img = card3.querySelector('img');
    img.src = './src/img/calculaColor.svg';
});
